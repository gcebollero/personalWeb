      ...
      <ul id="nav-mobile" class="side-nav show-on-medium-and-down">
        <li><div class="userView">
          <div class="background">
            <img src="../images/wood-background.jpg">
          </div>
  ...
  <div class="container">
    ...
    <div class="section">
      ...
      foreach ($json as $ability) {
        ...
        echo '<div class="col s12 m4"><div class="card">';
        echo '<div class="card-image waves-effect waves-block waves-light">';
        echo '<img class="activator" src="../images/java-logo.jpg">';
        echo '</div>';
        echo '<div class="card-content">';
        echo '<span class="card-title grey-text text-darken-4">';
        echo $ability->name_ES;
        echo '<i class="material-icons right">code</i></span>';
        ...
        echo '<a href="javaScript:void(0);" class="activator">Mas info</a>';
        echo '</div>';
        echo '<div class="card-reveal center">';
        echo '<span class="card-title grey-text text-darken-4">';
        echo $ability->name_ES;
